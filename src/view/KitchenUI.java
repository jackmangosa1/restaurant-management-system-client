                ...
                if (!e.getValueIsAdjusting()) {
                   ...
                   SelectedRowIndex = source.getSelectedRow();
                    ...
                    if (SelectedRowIndex >= 0) {
                        ...
                        //orderStatusList.setSelectedItem(orderStatus);
                       ...
                       try{
                           Registry theRegistry = LocateRegistry.getRegistry("127.0.0.1", 6000);
                            ...
                            List<OrderItem> orderItemsList =  orderItemService.allOrderItems();
                            ...
                            orderDetailsPanel.setBorder(BorderFactory.createTitledBorder(""));
